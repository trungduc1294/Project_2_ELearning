        ...
        @foreach ($questions as $question_index => $question)
            @if ($question['question_type'] == 'text')
                <div class="text_question bg-white rounded-lg mt-2">
                    ...
                    <h1 class="text-black px-4 mt-2 font-semibold">Câu {{$question_index}}: Điền đáp án đúng.</h1>
                    <div class="main_content p-4">
                        ...
                        <div class="'text_option'">
                            <input type="text" placeholder="Điền đáp án vào đây" class="w-2/3 mt-2 p-2 outline-none border-b border-dotted border-gray-300 text-gray-600">
                        </div>
                    </div>
                </div>
            @endif
            @if ($question['question_type'] == 'long_text')
                <div class="long_text_question bg-white rounded-lg mt-2">
                    ...
                    <div class="main_content p-4">
                        ...
                        <div class="'text_option'">
                            <textarea name="" id="" cols="30" rows="10" class="w-2/3 mt-2 p-2 outline-none border-b border-dotted border-gray-300 text-gray-600">
                                Điền đáp án
                            </textarea>
                        </div>
                    </div>
            ...
            @if ($question['question_type'] == 'multiple_choice')
                <div class="text_question bg-white rounded-lg mt-2">
                    <div class="top h-2 w-full bg-blue-500 rounded-t-lg"></div>
                    <h1 class="text-black px-4 mt-2 font-semibold">Câu {{$question_index}}: Chọn đáp án đúng.</h1>
                    <div class="main_content p-4">
                        <div class="question flex gap-8">
                            <p class="flex-1 px-2 py-4 outline-none bg-gray-100 border-b border-gray-700 text-black">{{$question['question_text']}}</p>
                            <span class="text-gray-700 w-40 border border-gray-300 rounded-md px-4 flex items-center">
                        ...
                        <div>
                            @foreach ($question['options_text'] as $index => $option_text)
                                <div class="option flex">
                                    ...
                                    <input type="radio" name="question_{{$question_index}}" class="ml-4">
                                </div>
                            @endforeach
                        </div>
                    </div>
