<div class="teacher_review_exam_of_student max-w-4xl py-10 mx-auto relative">
    ...
    {{-- Student Info --}}
    <div class="student_info bg-white rounded-lg mb-6 w-[200px] fixed left-10 top-[400px] shadow-xl">
        <div class="title_content p-6">
            <p class="w-full py-2 text-2xl text-black">
                {{$student->username}}
            </p>
            <p class="w-full py-2 outline-non text-black mt-4">
                {{$student->email}}
            </p>
        </div>
    </div>
